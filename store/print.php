...
<strong>Jaggi Canteen Online Ordering System</strong><br>Thapar University<br>Email Us:prabhjot409069@gmail.com.PH<br>Contact: <a href="#">09814181928</a> 
<br><br><br><br>
<?php
include('connect.php');
		$id=$_GET['id'];
		...
		while($row = mysql_fetch_array($result))
			{
				...
				echo 'note: if the Delivery Type is Outside Thapar It has an 500 delivery charge ';
