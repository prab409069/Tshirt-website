...
jQuery(function($){
        ...
        $.supersized({
            ...
            slides 					:  	[			// Slideshow Images
                                                {image : 'images/1.jpg', title : '<h1>Iron Man </h1><h2>We provide the best ironman t-shirt</h2><span>  </span></p>',},
                                                {image : 'images/2.jpg', title : '<h1>Captain America </h1><h2>We provide the best captain america t-shirt</h2> <span>  </span> </p>',},
												{image : 'images/3.jpg', title : '<h1>Batman</h1><h2>We provide the best batman t-shirt</h2></p>',}
										],
